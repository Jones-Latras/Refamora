...
export function buildListingAssistPrompt(input: ListingAssistInput) {
  return [
...
export function buildWasteValueAdvicePrompt(input: WasteValueAdviceInput) {
...
export function buildBuyerSearchPrompt(input: BuyerSearchAssistInput) {
  return [
...
export function buildInquirySummaryPrompt(input: InquirySummaryInput) {
