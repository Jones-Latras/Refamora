...
const KNOWLEDGE: WasteKnowledge[] = [
  {
    names: ['coconut husk', 'coconut_husk', 'coco husk'],
  ...
  {
    names: ['banana trunk', 'banana_trunk'],
  ...
  {
    names: ['sugarcane bagasse', 'sugarcane_bagasse'],
  ...
  {
    names: ['pineapple leaves', 'pineapple_leaves'],
  ...
  {
    names: ['cassava peel', 'cassava_peel'],
