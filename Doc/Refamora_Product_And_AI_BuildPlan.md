...
- [x] Add empty-state copy that reflects real state, not generic fallback text
...
- [x] Add soft session-expiry handling so users are not dropped into confusing auth states
